		...
		<header id="header">
            <div id="util">
                <div class="innerContent flex">
                    ...
                    <div class="util_menu">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/login_shop.jsp">로그인</a></li>
                            ...
                            <li><a href="${pageContext.request.contextPath}/notice.jsp">고객센터</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div id="layout_side" class="mobile layout_side">
                        ...
                        <div class="menuSide">
                            ...
                            <div class="aside_menu1">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/sub_new.html" target="_blank">NEW</a></li>
			...
			<div class="search_panel_wrapper Search Search_S">
				<div class="innerContent">	
					...
					<div id="subcatedepth1" class="ssSection">
						...
						<div class="ssCont">
							<div class="sBox"><a href="">All</a></div>
							<div class="sBox"><a href="" class="on">건강기능식품</a></div>
							<div class="sBox"><a href="">건강가공식품</a></div>			
							<div class="sBox"><a href="">가공식품</a></div>				
							<div class="sBox"><a href="">잡화</a></div>					
							<div class="sBox"><a href="">기타상품</a></div>				
							<div class="sBox"><a href="">사은품</a></div>
						</div><!--ssCont-->
					</div><!--subcatedepth1-->
					<div id="subcatedepth2" class="ssSection">
						<div class="ssTitle"><span>카테고리 '중'</span></div><!--ssTitle-->
						<div class="ssCont">
							<div class="sBox"><a href="" >2차메뉴</a></div>
							<div class="sBox"><a href="" >2차메뉴</a></div>
							<div class="sBox"><a href="" >2차메뉴</a></div>
							<div class="sBox"><a href="" >2차메뉴</a></div>
							<div class="sBox"><a href="" >2차메뉴</a></div>
				...
				<div class="align">
					<ul>
						...
						<li>
							...
							<label for="sort2">추천순</label>
						</li>
						<li>
							<input type="radio" id="sort3" class="radio" name="sort" value="">
							<label for="sort3">낮은가격순</label>
						</li>
						<li>
							<input type="radio" id="sort4" class="radio" name="sort" value="">
					...
					<div class="choice">
						<div>
							<select name="pageNum" class="tune">
