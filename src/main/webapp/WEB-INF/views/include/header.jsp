                ...
                <div class="innerContent">
                    <div id="categoryAll">
                        ...
                        <div class="categoryAll_abs">
                            <ul>
                                <li class="cate6">
                                    <a href="${pageContext.request.contextPath}/sub?c=&l=&keyword=">
                                        <span class="ca_i">
                                ...
                                <li class="cate0">
                                    <a href="${pageContext.request.contextPath}/sub?c=a&l=A&keyword=">
                                        <span class="ca_i">
                                    ...
                                    <ol>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=aa&l=B&keyword=">비타민</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=aaa&l=B&keyword=">프로바이오틱스</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=aaaa&l=B&keyword=">칼슘</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=aaaaa&l=B&keyword=">마그네슘</a></li>
                                    </ol>
                                </li>
                               
                                <li class="cate2">
                                    <a href="${pageContext.request.contextPath}/sub?c=b&l=A&keyword=">
                                        <span class="ca_i">
                                    ...
                                    <ol>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=b&l=B&keyword=">단백질</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=bb&l=B&keyword=">두유</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=bbb&l=B&keyword=">닭가슴살</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=bbbb&l=B&keyword=">아연</a></li>
                                    </ol>
                                </li>
                                <li class="cate3">
                                    <a href="${pageContext.request.contextPath}/sub?c=c&l=A&keyword=">
                                        <span class="ca_i">
                                    ...
                                    <ol>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=cc&l=B&keyword=">생활잡화</a></li>
                                    </ol>
                                </li>
                                <li class="cate4">
                                    <a href="${pageContext.request.contextPath}/sub?c=d&l=A&keyword=">
                                        <span class="ca_i">
                                     ...
                                     <ol>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=dd&l=B&keyword=">신선식품</a></li>
                                        <li><a href="${pageContext.request.contextPath}/sub?c=ddd&l=B&keyword=">차/티백</a></li>
                                    </ol>
                                </li>
                                <li class="cate5">
                                    <a href="${pageContext.request.contextPath}/sub?c=e&l=A&keyword=">
                                        <span class="ca_i">
