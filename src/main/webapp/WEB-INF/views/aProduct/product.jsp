            ...
            <div id="listdiv">
                ...
                <form name="signForm" method="post" onsubmit="return false;">
                    ...
                    <table class="listTbl fixed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="listData">치킨</td>
                                <td class="listData">
                                    <nobr><b><a href="/">굽네치킨</a></b></nobr>
                                </td>
                                <td class="listData">브라질산 닭</td>
                                <td class="listData" >
                                	<nobr><b><a href="/">GN-0001234</a></b></nobr>
                                </td>
                                <td class="listData">2021-11-24</td>
                                <td class="listData">300EA</td>
                                <td class="listData">12,520</td>
                                    <td class="listData">2021-11-28</td>
                                        <td class="listData">2021-11-28</td>
                                <td class="listData">
                    ...
                    <div class="adBtn"><button class="adbtn1" onclick="location.href='${pageContext.request.contextPath}/aEvent/newCoupon'" >상품수정</button></div>
                       <div class="adBtn"><button class="adbtn1" onclick="location.href='${pageContext.request.contextPath}/aEvent/newCoupon'" >상품등록</button></div>
                </form>
            </div>
