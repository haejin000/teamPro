					...
					<div class="detailArea ">
						...
						<div class="product-inform">
							<div class="infoArea">
								<div class="prd_title">
									<div class="t1"></div>
									<div class="t2">${goodsView.goodsNm}</div>
								...
								<div class="priceWrap">
									<div class="discountPriceInfo">
										...
										<div class="listPrice view_price">
											<span>${goodsView.goodsPrice}</span><em>원</em>
										</div>
									</div>
									<div class="priceInfo">
								...
								<div class="optionContent">
									<div class="priceOptionBox">
										<div class="price">
											...
											<span class="won"><fmt:formatNumber type="currency"  value= "${ goodsView.fixedPrice }" /><em>원</em></span>
										</div>
									</div>
								</div><!-- optionContent  -->
								<div class="btnCart">
				...
				<div class="item-display-wrap">
					<div class="item-display type-cart clear cboth">
						<div class="swiper proRecommend list innerContent">
							...
							<c:forEach items="${subAll }" var="ListDTO">
								<li class="swiper-slide line_5">
									<div class="space">
										<div class="PJ_goods_border">
											<div class="thumbnail">
												<a href=""></a>
												<img src="<c:url value="${ListDTO.imagePath}"/>" alt="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" title="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" class="middle">
												<span class="hot"></span>
												<span class="choice">
											...
											<div class="price gd-default">
												<span class="cost">
													<strong><fmt:formatNumber type="currency"  value= "${ ListDTO.goodsPrice }" /><em class="pr_unit">원</em></strong>
												</span>
												<span class="del">${ ListDTO.fixedPrice }원 </span>
				...
				<div class="detail-contents">
					...
					<div class="detailImg innerContent">
						<p class="detailImg_pc">
							<img src="<c:url value="${goodsView.gdsThumbImg}"/>"><!--상세정보 이미지  -->
						</p><!--  detailImg_pc  -->
						<p class="detailImg_mo">
							<img src="<c:url value="${goodsView.gdsThumbImg}"/>" />
						</p><!--  detailImg_mo  -->
					</div><!--  detailInfo  -->
					</div><!--detail-->
					...
					<c:import url="comment.jsp">
							<c:param name="goodsNo" value="1"></c:param> 
					</c:import>
