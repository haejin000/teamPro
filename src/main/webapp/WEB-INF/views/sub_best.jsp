								...
								<li class="line_4">
									<div class="space">
										<div class="PJ_goods_border">
											<div class="thumbnail">
												<a href=""></a>
												<img src="/images/proimg1.jpg" alt="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" title="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" class="middle">
												<span class="hot"></span>
												<span class="choice">
								...
								<li class="line_4">
									<div class="space">
										<div class="PJ_goods_border">
											<div class="thumbnail">
												<a href=""></a>
												<img src="/images/proimg2.jpg" alt="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" title="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" class="middle">
												<span class="hot"></span>
												<span class="choice">
													<button href="" type="button" class="cart btn-open-layer btn-add-cart14">장바구니</button>
												</span>
								...
								<li class="line_4">
									<div class="space">
										<div class="PJ_goods_border">
											<div class="thumbnail">
												<a href=""></a>
												<img src="/images/proimg3.jpg" alt="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" title="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" class="middle">
												<span class="hot"></span>
												<span class="choice">
													<button href="" type="button" class="cart btn-open-layer btn-add-cart14">장바구니</button>
												</span>
								...
								<li class="line_4">
									<div class="space">
										<div class="PJ_goods_border">
											<div class="thumbnail">
												<a href=""></a>
												<img src="/images/proimg4.jpg" alt="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" title="5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중" class="middle">
												<span class="hot"></span>
												<span class="choice">
													<button href="" type="button" class="cart btn-open-layer btn-add-cart14">장바구니</button>
												</span>
